/*
 * From https://github.com/FabricMC/fabric/blob/1.16/fabric-api-base/src/main/java/net/fabricmc/fabric/api/event/EventFactory.java
 * 
 */
...
package dev.tr7zw.transliterationlib.api.event.api;

import java.util.function.Function;

import dev.tr7zw.transliterationlib.api.event.impl.EventFactoryImpl;

/**
 * Helper for creating {@link TREvent} classes.
 */
public final class TREventFactory {
	private static boolean profilingEnabled = true;

	private TREventFactory() { }
	...
	public static <T> TREvent<T> createArrayBacked(Class<T> type, T emptyInvoker, Function<T[], T> invokerFactory) {
