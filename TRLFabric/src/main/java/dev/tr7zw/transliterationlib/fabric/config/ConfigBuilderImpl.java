package dev.tr7zw.transliterationlib.fabric.config;
...
public class ConfigBuilderImpl implements ConfigBuilder {
	...
	public WrappedScreen build() {
		return TRansliterationLib.transliteration.getWrapper().wrapScreen(builder.build());
	}
	...
	private class FabricConfigEntryBuilder implements ConfigEntryBuilder {
		...
		private class FabricEnumSelectorBuilder<T extends Enum<?>> implements EnumSelectorBuilder<T>{
			...
			public WrappedConfigEntry build() {
				return TRansliterationLib.transliteration.getWrapper().getWrappedConfigEntry(builder.build());
			}
